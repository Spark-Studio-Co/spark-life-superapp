        ...
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-6">
          {isError ? (
            <motion.div variants={itemVariants} className="text-center py-8">
              <p className="text-gray-500 mb-4">Не удалось загрузить данные профиля</p>
                ...
                {isLoading ? (
                  ...
                  <>
                    <Avatar className="h-16 w-16 border-2 border-white shadow-md">
                      <AvatarImage src="/thoughtful-woman-profile.png" alt={user?.first_name} />
                    ...
                    <div>
                      ...
                      <p className="text-gray-500">{user?.email || "Загрузка..."}</p>
                    </div>
                  </>
                )}
              </motion.div>
                    ...
                    {isLoading ? (
                      ...
                      <>
                        ...
                        <div className="flex justify-between py-2">
                          ...
                          <span className="font-medium">{user?.gender || "Не указан"}</span>
                        </div>
                        <Separator />
                        <div className="flex justify-between py-2">
                          <span className="text-gray-500">Рост</span>
                          <span className="font-medium">{user?.height ? `${user.height} см` : "Не указан"}</span>
                        </div>
                        <Separator />
                        <div className="flex justify-between py-2">
                          <span className="text-gray-500">Вес</span>
                          <span className="font-medium">{user?.weight ? `${user.weight} кг` : "Не указан"}</span>
                        </div>
                        <Separator />
                        <div className="flex justify-between py-2">
