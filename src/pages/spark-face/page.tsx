                                        ...
                                        <div className="text-center p-6">
                                            {cameraError ? (
                                                ...
                                                <>
                                                    ...
                                                    <p>Камера активна</p>
                                                    <p className="text-xs text-muted-foreground mt-2">Расположите лицо в центре кадра</p>
                                                    <video
                                                        ref={videoRef}
                            ...
                            >
                                <div className="aspect-square w-full bg-card rounded-2xl overflow-hidden relative flex flex-col items-center justify-center p-6 shadow-lg border border-border">
                                    ...
                                    >
                                        ...
                                        <p className="text-sm text-muted-foreground">Наши алгоритмы изучают состояние вашей кожи</p>
                                    </motion.div>
                                    ...
                                    <motion.div
                                        ...
                                        transition={{ duration: 2.5, repeat: Number.POSITIVE_INFINITY, repeatType: "loop", delay: 0.5 }}
                                    />
                                    <motion.div
