...
import { Building2, Phone, MapPin, ArrowLeft, CalendarPlus, Clock, Info, Star } from "lucide-react"
...
export default function RecommendedClinicsPage() {
    ...
    const servicesData: Service[] = [
        ...
        },
        {
            ...
            description: "Услуга: кардиологический скрининг. Качественная диагностика и лечение.",
            price: 1121,
        },
        {
            clinic_id: "81322adc-f043-4b9b-8598-2c5ca0128d67",
        ...
        },
        {
            ...
            description: "Услуга: холтеровское мониторирование. Качественная диагностика и лечение.",
            price: 998,
        },
        {
            clinic_id: "16154442-8ac7-4283-9ae6-603b66504757",
            name: "Диетологическая консультация",
            description: "Услуга: диетологическая консультация. Качественная диагностика и лечение.",
            price: 2448,
        },
    ]
                                        ...
                                        <div className="px-4">
                                            <div className="flex justify-between items-start">
                                                <div className="">
                                                    ...
                                                    <p className="font-semibold text-blue-600 mt-2">{formatPrice(service.price)} ₽</p>
                                                </div>
                                            </div>
                                        </div>
                                    </CardContent>
                                    <CardFooter className="p-4 pt-0 flex gap-2">
                                        <Button variant="outline" className="flex-1" onClick={() => navigation(`/clinics/${service.clinic_id}`)}>
